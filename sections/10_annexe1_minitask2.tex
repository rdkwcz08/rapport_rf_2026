...
\section{PCB Routing on Kicad}
\label{sec:PCBRouting}
\subsection{One diode}
Here is the routing plan : 
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/1d_routing_plan.png}
    \caption{1 diodes routing plan.}
    \label{fig:1d_routing_plan}
\end{figure}
\subsection{Two diode}
Here is the routing plan : 
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/2d_routing_plan.png}
    \caption{2 diodes routing plan.}
    \label{fig:2d_routing_plan}
\end{figure}