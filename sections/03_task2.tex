...
Main parameters we focused on are : \begin{enumerate}
    \item \textbf{Saturation current $I_s$}
    \begin{itemize}
        \item Represents the current flowing at zero voltage. The higher $I_s$, the more easily the diode conducts at low voltage
    \end{itemize}

    \item \textbf{Series resistance $R_s$}
    \begin{itemize}
        \item Internal parasitic resistance of the diode. The lower $R_s$, the lower the Joule losses
    \end{itemize}

    \item \textbf{Junction capacitance $C_j$}
    \begin{itemize}
        \item This is the most critical parameter at high frequency. The lower $C_j$, the lower the insertion losses at high frequency
    \end{itemize}

    \item \textbf{Maximum operating frequency $F$}
    \begin{itemize}
        \item The diode must be able to operate at the target frequency
    \end{itemize}
\end{enumerate}
