...
\begin{itemize}
    ...
    \item \textbf{Load resistor:} $R_1 = R_L$, it represents the equivalent
          input resistance of our sensor (STTS22H).
...
Something we noticed while doing the practical work was that the $S_{11}$ curve in Figure~\ref{fig:s11_matched_lumped}
