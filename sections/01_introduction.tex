...
of application, operating frequency, and Schottky diode. Sections~\ref{sec:task3_1} and  \ref{sec:task3_2}
details the design and simulation of the one-diode rectifier topology, including 
impedance matching optimization. Sections~\ref{sec:task4_1} and \ref{sec:task4_2} are extending this analysis to 
the two-diode configuration. Finally, a comparative 
